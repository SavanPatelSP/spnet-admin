  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <StatCard title="Platform Health" value={activePolicies === securityPolicies.length ? "Healthy" : "Review Required"} icon={CheckCircle} color={activePolicies === securityPolicies.length ? "green" : "yellow"} />
      </div>
