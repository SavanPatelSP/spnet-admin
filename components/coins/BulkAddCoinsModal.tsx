  ...
  async function handleAdd() {
    ...
    try {
      const res = await fetch(API_ROUTES.COINS.BULK_ADD, {
        ...
        body: JSON.stringify({ licenseIds, amount, reason: reason || null, description: description || null }),
      });
    ...
    <Modal
      ...
      footer={
        <>
          ...
          <ActionButton variant="primary" onClick={handleAdd} loading={loading}>
            Add to {licenseIds.length} Licenses
          </ActionButton>
        </>
      }
    >
